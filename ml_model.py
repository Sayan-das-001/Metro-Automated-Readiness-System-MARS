"""
Machine Learning module for MARS Metro Automated Readiness System.
...
def prepare_training_data(odoo_data: Dict[str, pd.DataFrame], 
    ...
    if not maintenance_df.empty:
        ...
        maintenance_counts['train_id'] = maintenance_counts['equipment_id'].apply(lambda x: f"MARS-{x:03d}")
